...
public class Factoring32 {
    public static void main(String[] args) {
        SecureRandom secureRandom = new SecureRandom();
        byte[] keyBytes = new byte[4]; // 4 bytes = 32 bits
        ...
        BigInteger q = generateRandomPrime(16); // Gerando um número primo pequeno (16 bits) para uma chave de 32 bits
