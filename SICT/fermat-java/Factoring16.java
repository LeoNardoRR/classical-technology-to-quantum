...
public class Factoring16 {
    public static void main(String[] args) {
        SecureRandom secureRandom = new SecureRandom();
        byte[] keyBytes = new byte[2]; // 2 bytes = 16 bits
        ...
        BigInteger q = generateRandomPrime(8); // Gerando um número primo pequeno (8 bits) para uma chave de 16 bits
